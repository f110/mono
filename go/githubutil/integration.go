...
func (g *GitHubClientFactory) Init() error {
	...
	if g.AppID > 0 && g.InstallationID > 0 && g.PrivateKeyFile != "" {
		slogger.Log.Debug("Set up with GitHub App", slog.Int64("app_id", g.AppID), slog.Int64("installation_id", g.InstallationID), slog.String("private_key_file", g.PrivateKeyFile))
