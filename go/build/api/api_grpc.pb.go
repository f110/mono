...
func (c *aPIClient) GetServerInfo(ctx context.Context, in *RequestGetServerInfo, opts ...grpc.CallOption) (*ResponseGetServerInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseGetServerInfo)
	err := c.cc.Invoke(ctx, API_GetServerInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) ListExternalReleaseTriggers(ctx context.Context, in *RequestListExternalReleaseTriggers, opts ...grpc.CallOption) (*ResponseListExternalReleaseTriggers, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseListExternalReleaseTriggers)
	err := c.cc.Invoke(ctx, API_ListExternalReleaseTriggers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAPIServer) GetServerInfo(context.Context, *RequestGetServerInfo) (*ResponseGetServerInfo, error) {
...
func _API_GetServerInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_GetServerInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).GetServerInfo(ctx, req.(*RequestGetServerInfo))
	}
	return interceptor(ctx, in, info, handler)
}

func _API_ListExternalReleaseTriggers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestListExternalReleaseTriggers)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).ListExternalReleaseTriggers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_ListExternalReleaseTriggers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).ListExternalReleaseTriggers(ctx, req.(*RequestListExternalReleaseTriggers))
	}
	return interceptor(ctx, in, info, handler)
}
