...
const file_src_main_protobuf_failure_details_proto_rawDesc = "" +
	...
	"\texit_code\x18\x01 \x01(\rR\bexitCode\"\xc0#\n" +
	...
	"'BES_UPLOAD_RETRY_LIMIT_EXCEEDED_FAILURE\x10\x11\x1a\x05\xb2C\x02\b&\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02\"\x04\b\x12\x10\x12\"\x04\b\x14\x10\x14\"\xee\x02\n" +
	"\rRemoteOptions\x127\n" +
	"\x04code\x18\x01 \x01(\x0e2#.failure_details.RemoteOptions.CodeR\x04code\"\xa3\x02\n" +
	"\x04Code\x12!\n" +
	...
	"\x1cEXECUTION_WITH_INVALID_CACHE\x10\x05\x1a\x05\xb2C\x02\b\x02\x12#\n" +
	"\x18EXECUTION_WITH_SCRUBBING\x10\x06\x1a\x05\xb2C\x02\b\x02\"\xa0\x01\n" +
	...
	"*REDUCED_CLASSPATH_FALLBACK_CLEANUP_FAILURE\x10\x04\x1a\x05\xb2C\x02\b$\"\xed\x01\n" +
	"\x0fActionRewinding\x129\n" +
	"\x04code\x18\x01 \x01(\x0e2%.failure_details.ActionRewinding.CodeR\x04code\"\x9e\x01\n" +
	"\x04Code\x12#\n" +
	...
	"\x14LOST_INPUT_IS_SOURCE\x10\x02\x1a\x05\xb2C\x02\b\x01\x12*\n" +
	"\x1fREWIND_LOST_INPUTS_PREREQ_UNMET\x10\x03\x1a\x05\xb2C\x02\b\x02\"\x93\x04\n" +
	"\n" +
	"CppCompile\x124\n" +
	...
	"\x10DIFF_STAT_FAILED\x10\x01\x1a\x05\xb2C\x02\b$\"\xc6\x01\n" +
	"\n" +
	"ModCommand\x124\n" +
	"\x04code\x18\x01 \x01(\x0e2 .failure_details.ModCommand.CodeR\x04code\"\x81\x01\n" +
	"\x04Code\x12\x1e\n" +
