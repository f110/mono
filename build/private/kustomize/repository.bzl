load("//build/private/kustomize:assets.bzl", "KUSTOMIZE_ASSETS")
...
def _kustomize_binary_impl(ctx):
    ...
    multi_platform_download_and_extract(ctx, KUSTOMIZE_ASSETS[ctx.attr.version], Label("//build/private/kustomize:BUILD.kustomize.bazel"))
