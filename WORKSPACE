...
http_archive(
    ...
    urls = [
        ...
        "https://github.com/bazelbuild/rules_go/releases/download/v0.42.0/rules_go-v0.43.0.zip",
        "https://mirror.bucket.x.f110.dev/github.com/bazelbuild/rules_go/releases/download/v0.43.0/rules_go-v0.43.0.zip",
    ],
)
